...
class ElevationSceneCfg(InteractiveSceneCfg):
    ...
    ground = AssetBaseCfg(
        ...
        spawn = sim_utils.GroundPlaneCfg(size=(600.0, 200.0),
                                         color=(3,3,3),
                                         physics_material=sim_utils.RigidBodyMaterialCfg(
                                            static_friction=1.0,
    ...
    height_scanner = RayCasterCfg(
        ...
        pattern_cfg=patterns.GridPatternCfg(size=[0.5, 0.5], resolution=1),
        debug_vis=False,
...
class MushrElevationRLEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.sim.dt = 0.1  # 10 Hz
        self.decimation = 1  # 動作頻率為 10Hz
        self.actions.throttle_steer.scale = (3.0, 0.488)
        self.sim.render_interval = self.decimation*2000
